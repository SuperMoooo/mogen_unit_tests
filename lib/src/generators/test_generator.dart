...
class TestGenerator {
  ...
  void _imports(StringBuffer b, NotifierInfo n) {
    ...
    for (final repo in filteredRepos) {
      ...
      // Import only the domain repository interface
      b.writeln(
  ...
  void _methodSuccessTest(StringBuffer b, MethodInfo method, NotifierInfo n,
    ...
    _verifyCalledMethods(b, method, n, filteredRepos);
    b.writeln('      });');
    b.writeln();
  }
  ...
  void _stubOnlyCalledMethods(
    ...
    for (final repo in filteredRepos) {
      // Detect only methods actually called in the notifier
  ...
  void _verifyCalledMethods(StringBuffer b, MethodInfo method, NotifierInfo n,
      List<RepositoryDep> filteredRepos) {
    if (filteredRepos.isEmpty) return;
